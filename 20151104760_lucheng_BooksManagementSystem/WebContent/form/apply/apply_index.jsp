				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="apply_index.do" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
								...
								<fieldset>
									...
									<input type="text" id="query_user_id" placeholder="读者" value="${map.user_id}">
					...
					<td>
						...
						<td>
							<div class="hidden-sm hidden-xs btn-group">
								<c:if test="${empty map.updateTime&&map.is_overdue==1}">
										<button class="btn btn-xs btn-info" onclick="updateApplyData('${zhangHu.student_id }','${map.book_id}','${map.id}')" title="逾期归还">逾期归还</button>
								</c:if>
							</div>
						</td>
					</tr>
