				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="book_index.do?isUser=1" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
		...
		<table id="sample-table-1" class="table  table-bordered dataTable"> 
			<thead>
				<tr>
					...
					<th field="bz"  onclick="querySort(this,'query_Book')">
						备注
					</th>
					<th width="110">
						操作
						...
						<td>
							<div class="hidden-sm hidden-xs btn-group">
								<c:if test="${map.status==0}">
									<button class="btn btn-xs btn-danger" onclick="addApplyData('${zhangHu.student_id }','${map.id}')" title="借书">借书</button>
								</c:if>
							</div>
						</td>
					</tr>
