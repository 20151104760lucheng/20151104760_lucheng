			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="手机号" id="update_phone" class="col-xs-12"
						data-validate="required:手机号必填" value="${map.phone}" onchange="$('#isUpdate').attr('value','y')">
				</span>
			</div>
		</div>
			<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="昵称" id="update_nick_name" class="col-xs-12"
						data-validate="required:昵称必填" value="${map.nick_name}" onchange="$('#isUpdate').attr('value','y')">
				</span>
			</div>
		</div>
			<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="性别" id="update_sex" class="col-xs-12"
						data-validate="required:性别必填" value="${map.sex}" onchange="$('#isUpdate').attr('value','y')">
				</span>
			</div>
		</div>
			<div class="form-group field">
			...
			<div class="col-sm-5">
				<span class="block input-icon input-icon-right">
					<input type="text" placeholder="年龄" id="update_age" class="col-xs-12"
						data-validate="required:年龄必填" value="${map.age}" onchange="$('#isUpdate').attr('value','y')">
				</span>
			</div>
		</div>
